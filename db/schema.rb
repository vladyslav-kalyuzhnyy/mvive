...
ActiveRecord::Schema.define(version: 20170612132703) do
  ...
  create_table "blog_olena_nazars", force: :cascade do |t|
    t.integer  "user_id"
    t.string   "name"
    t.text     "short"
    t.string   "news_day"
  ...
  add_index "blog_olena_nazars", ["slug"], name: "index_blog_olena_nazars_on_slug", unique: true, using: :btree
