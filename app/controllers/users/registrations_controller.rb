class Users::RegistrationsController < Devise::RegistrationsController
  ...
  def configure_sign_up_params
    devise_parameter_sanitizer.permit(:sign_up, keys: [:email, :type])
  end

  # If you have extra params to permit, append them to the sanitizer.
  def configure_account_update_params
    devise_parameter_sanitizer.permit(:account_update, keys: [:name, :surname, :about, :country_code, :city, :avatar, :cover, :password, :sex, :birthday, :password_confirmation, :current_password])
  end
